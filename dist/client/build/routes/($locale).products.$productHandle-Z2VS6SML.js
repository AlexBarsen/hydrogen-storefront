...
function s5(t, o5) {
  let { features: n = 1, ...e3 } = t, d2 = { ref: o5, "aria-hidden": (n & 2) === 2 ? true : void 0, style: { position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0", ...(n & 4) === 4 && (n & 2) !== 2 && { display: "none" } } };
  return X({ ourProps: d2, theirProps: e3, slot: {}, defaultTag: a2, name: "Hidden" });
}
var c2 = D(s5);
...
function T2(l2, r2, c3) {
  let [i2, s6] = (0, import_react2.useState)(c3), e3 = l2 !== void 0, t = (0, import_react2.useRef)(e3), u3 = (0, import_react2.useRef)(false), d2 = (0, import_react2.useRef)(false);
  return e3 && !t.current && !u3.current ? (u3.current = true, t.current = e3, console.error("A component is changing from uncontrolled to controlled. This may be caused by the value changing from undefined to a defined value, which should not happen.")) : !e3 && t.current && !d2.current && (d2.current = true, t.current = e3, console.error("A component is changing from controlled to uncontrolled. This may be caused by the value changing from a defined value to undefined, which should not happen.")), [e3 ? l2 : i2, o2((n) => (e3 || s6(n), r2 == null ? void 0 : r2(n)))];
}
...
function X2(e3, a3 = (o5) => o5) {
  let o5 = e3.activeOptionIndex !== null ? e3.options[e3.activeOptionIndex] : null, r2 = I2(a3(e3.options.slice()), (t) => t.dataRef.current.domRef.current), l2 = o5 ? r2.indexOf(o5) : null;
...
var Ne = { [1](e3) {
  ...
  if (e3.dataRef.current.disabled || e3.listboxState === 0)
    return e3;
  let a3 = e3.activeOptionIndex, { isSelected: o5 } = e3.dataRef.current, r2 = e3.options.findIndex((l2) => o5(l2.dataRef.current.value));
  return r2 !== -1 && (a3 = r2), { ...e3, listboxState: 0, activeOptionIndex: a3 };
}, [2](e3, a3) {
  var l2;
  if (e3.dataRef.current.disabled || e3.listboxState === 1)
    return e3;
  let o5 = X2(e3), r2 = x(a3, { resolveItems: () => o5.options, resolveActiveIndex: () => o5.activeOptionIndex, resolveId: (t) => t.id, resolveDisabled: (t) => t.dataRef.current.disabled });
  return { ...e3, ...o5, searchQuery: "", activeOptionIndex: r2, activationTrigger: (l2 = a3.trigger) != null ? l2 : 1 };
}, [3]: (e3, a3) => {
  if (e3.dataRef.current.disabled || e3.listboxState === 1)
    return e3;
  let r2 = e3.searchQuery !== "" ? 0 : 1, l2 = e3.searchQuery + a3.value.toLowerCase(), p3 = (e3.activeOptionIndex !== null ? e3.options.slice(e3.activeOptionIndex + r2).concat(e3.options.slice(0, e3.activeOptionIndex + r2)) : e3.options).find((i2) => {
    var b;
  ...
  let o5 = { id: a3.id, dataRef: a3.dataRef }, r2 = X2(e3, (l2) => [...l2, o5]);
  return e3.activeOptionIndex === null && e3.dataRef.current.isSelected(a3.dataRef.current.value) && (r2.activeOptionIndex = r2.options.indexOf(o5)), { ...e3, ...r2 };
}, [6]: (e3, a3) => {
  let o5 = X2(e3, (r2) => {
    let l2 = r2.findIndex((t) => t.id === a3.id);
    return l2 !== -1 && r2.splice(l2, 1), r2;
  });
  return { ...e3, ...o5, activationTrigger: 1 };
}, [7]: (e3, a3) => ({ ...e3, labelId: a3.id }) };
var $ = (0, import_react3.createContext)(null);
$.displayName = "ListboxActionsContext";
function U(e3) {
  let a3 = (0, import_react3.useContext)($);
  if (a3 === null) {
...
function B(e3) {
  let a3 = (0, import_react3.useContext)(z);
  if (a3 === null) {
    let o5 = new Error(`<${e3} /> is missing a parent <Listbox /> component.`);
...
function je(e3, a3) {
  return u(a3.type, Ne, e3, a3);
}
var Ve = import_react3.Fragment;
function Ke(e3, a3) {
  let { value: o5, defaultValue: r2, form: l2, name: t, onChange: p3, by: u3 = (s6, d2) => s6 === d2, disabled: i2 = false, horizontal: b = false, multiple: R2 = false, ...m } = e3;
  const P = b ? "horizontal" : "vertical";
  let E = y(a3), [L2 = R2 ? [] : void 0, v] = T2(o5, p3, r2), [c3, n] = (0, import_react3.useReducer)(je, { dataRef: (0, import_react3.createRef)(), listboxState: 1, options: [], searchQuery: "", labelId: null, activeOptionIndex: null, activationTrigger: 1 }), x2 = (0, import_react3.useRef)({ static: false, hold: false }), h2 = (0, import_react3.useRef)(null), Q = (0, import_react3.useRef)(null), J = (0, import_react3.useRef)(null), y2 = o2(typeof u3 == "string" ? (s6, d2) => {
    let O = u3;
    return (s6 == null ? void 0 : s6[O]) === (d2 == null ? void 0 : d2[O]);
  } : u3), S2 = (0, import_react3.useCallback)((s6) => u(T3.mode, { [1]: () => L2.some((d2) => y2(d2, s6)), [0]: () => y2(L2, s6) }), [L2]), T3 = (0, import_react3.useMemo)(() => ({ ...c3, value: L2, disabled: i2, mode: R2 ? 1 : 0, orientation: P, compare: y2, isSelected: S2, optionsPropsRef: x2, labelRef: h2, buttonRef: Q, optionsRef: J }), [L2, i2, R2, c3]);
  l(() => {
    c3.dataRef.current = T3;
  }, [T3]), L([T3.buttonRef, T3.optionsRef], (s6, d2) => {
    var O;
    n({ type: 1 }), h(d2, T.Loose) || (s6.preventDefault(), (O = T3.buttonRef.current) == null || O.focus());
  }, T3.listboxState === 0);
  let ne = (0, import_react3.useMemo)(() => ({ open: T3.listboxState === 0, disabled: i2, value: L2 }), [T3, i2, L2]), ie = o2((s6) => {
    let d2 = T3.options.find((O) => O.id === s6);
    d2 && F(d2.dataRef.current.value);
  }), re = o2(() => {
    if (T3.activeOptionIndex !== null) {
      let { dataRef: s6, id: d2 } = T3.options[T3.activeOptionIndex];
      F(s6.current.value), n({ type: 2, focus: a.Specific, id: d2 });
    }
  }), ae = o2(() => n({ type: 0 })), le = o2(() => n({ type: 1 })), se = o2((s6, d2, O) => s6 === a.Specific ? n({ type: 2, focus: a.Specific, id: d2, trigger: O }) : n({ type: 2, focus: s6, trigger: O })), pe = o2((s6, d2) => (n({ type: 5, id: s6, dataRef: d2 }), () => n({ type: 6, id: s6 }))), ue = o2((s6) => (n({ type: 7, id: s6 }), () => n({ type: 7, id: null }))), F = o2((s6) => u(T3.mode, { [0]() {
    return v == null ? void 0 : v(s6);
  }, [1]() {
    let d2 = T3.value.slice(), O = d2.findIndex((M) => y2(M, s6));
    return O === -1 ? d2.push(s6) : d2.splice(O, 1), v == null ? void 0 : v(d2);
  } })), de = o2((s6) => n({ type: 3, value: s6 })), ce = o2(() => n({ type: 4 })), fe = (0, import_react3.useMemo)(() => ({ onChange: F, registerOption: pe, registerLabel: ue, goToOption: se, closeListbox: le, openListbox: ae, selectActiveOption: re, selectOption: ie, search: de, clearSearch: ce }), []), Te = { ref: E }, H = (0, import_react3.useRef)(null), be = p();
  return (0, import_react3.useEffect)(() => {
    H.current && r2 !== void 0 && be.addEventListener(H.current, "reset", () => {
      F(r2);
    });
  }, [H, F]), import_react3.default.createElement($.Provider, { value: fe }, import_react3.default.createElement(z.Provider, { value: T3 }, import_react3.default.createElement(c, { value: u(T3.listboxState, { [0]: d.Open, [1]: d.Closed }) }, t != null && L2 != null && e2({ [t]: L2 }).map(([s6, d2], O) => import_react3.default.createElement(c2, { features: p2.Hidden, ref: O === 0 ? (M) => {
    var q;
    H.current = (q = M == null ? void 0 : M.closest("form")) != null ? q : null;
  } : void 0, ...R({ key: s6, as: "input", type: "hidden", hidden: true, readOnly: true, form: l2, name: s6, value: d2 }) })), X({ ourProps: Te, theirProps: m, slot: ne, defaultTag: Ve, name: "Listbox" }))));
}
var Qe = "button";
function We(e3, a3) {
  var v;
  let o5 = I(), { id: r2 = `headlessui-listbox-button-${o5}`, ...l2 } = e3, t = B("Listbox.Button"), p3 = U("Listbox.Button"), u3 = y(t.buttonRef, a3), i2 = p(), b = o2((c3) => {
    switch (c3.key) {
      case o3.Space:
      case o3.Enter:
      case o3.ArrowDown:
...
var Xe = "label";
function $e(e3, a3) {
  let o5 = I(), { id: r2 = `headlessui-listbox-label-${o5}`, ...l2 } = e3, t = B("Listbox.Label"), p3 = U("Listbox.Label"), u3 = y(t.labelRef, a3);
...
function qe(e3, a3) {
  var c3;
  let o5 = I(), { id: r2 = `headlessui-listbox-options-${o5}`, ...l2 } = e3, t = B("Listbox.Options"), p3 = U("Listbox.Options"), u3 = y(t.optionsRef, a3), i2 = p(), b = p(), R2 = C(), m = (() => R2 !== null ? (R2 & d.Open) === d.Open : t.listboxState === 0)();
...
//# sourceMappingURL=/build/routes/($locale).products.$productHandle-Z2VS6SML.js.map
